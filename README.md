...
Поддерживается:
* разбивка по страницам с добалением навигации между страницами
* формирование списка запросов в виде оглавления с интерактивными ссылками для перехода на оригинальный запрос
* преобразование диалогов в структурированные блоки запросов
* восстановление таблиц
* форматирование кода
* группировки различных запросов в консолидированые страницы в любых сочетаниях
* дополнительные функции для дальнейших манипуляций - например, объединение разных экспортов в общие структуры вручную можно организовать, указав сдвиг стартового номера генерации страниц
...
### 🔧 Возможности
  ...
  * 🔁 Конвертация HTML в Markdown с сохранением структуры диалогов.

  * 🧠 Форматирование запросов и ответов в виде блоков с заголовками.
  ...
  * ⚙️ Настройка тегов через `config.ini`.
...
### 🚩 Пререквизиты
  ...
  * Откройте нужный чат
  * Сохраните страницу в формате MHTML
  * Используйте MHTML файл для дальнейших операций импорта в Obsidian
