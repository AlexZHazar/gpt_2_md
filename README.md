...
Приложение на PySide6 для конвертации MHTML-файлов (с диалогами ChatGPT или DeepSeek) в
...
### 🚩 Пререквизиты
  ...
  * Откройте нужную страницу ChatGPT или DeepSeek
...
* Не может распознать SVG диаграммы в DeepSeek - рекомендуется при сохранении в MHTML включать их отображение в виде кода - тогда всё работает.
